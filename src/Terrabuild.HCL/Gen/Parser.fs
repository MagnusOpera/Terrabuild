...
module internal Terrabuild.HCL.Parser
...
# 324 "Gen/Parser.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _1 = parseState.GetInput(1) :?> Terrabuild.HCL.AST.File in
...
let File lexer lexbuf : Terrabuild.HCL.AST.File =
