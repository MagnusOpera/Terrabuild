...
type IApiClient =
    ...
    abstract BuildAddArtifact: buildId:string -> project:string -> target:string -> projectHash:string -> targetHash:string  -> files:string list -> size:int -> success:bool -> Unit
