...
self: clean publish
	.out/dotnet/terrabuild run build test dist --configuration $(config) --retry --debug --log --local-only

self-logs:
	.out/dotnet/terrabuild logs build test dist --configuration $(config) --debug --log --local-only
